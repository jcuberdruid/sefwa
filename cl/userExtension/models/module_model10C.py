...
def model(numLabels):
    ...
    model.add(Flatten())
    model.add(Dense(units=32, activation='sigmoid', kernel_regularizer=l1(0.002), name='dense'))
    model.add(Dropout(rate=0.6, name="dropout_2"))
    model.add(Dense(units=16, activation='sigmoid', kernel_regularizer=l1(0.005), name='dense_1'))
