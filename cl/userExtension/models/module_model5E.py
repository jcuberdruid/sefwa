...
def model(numLabels):
    ...
    gru_layer1 = GRU(units=32, return_sequences=True)(reshape_layer)
    #dropout2 = Dropout(0.1)(gru_layer1)
    batchnorm2 = BatchNormalization()(gru_layer1)
    gru_layer2 = GRU(units=64)(batchnorm2)
    dense_layer = Dense(units=896, activation='relu', kernel_regularizer=l1(0.005))(gru_layer2)
    ...
    gru_layer3 = GRU(units=128, return_sequences=True)(reshape_layer2)
    #dropout4 = Dropout(0.1)(gru_layer3)
    batchnorm4 = BatchNormalization()(gru_layer3)
    gru_layer4 = GRU(units=32)(batchnorm4)
    dense_layer2 = Dense(units=384, activation='relu', kernel_regularizer=l1(0.005))(gru_layer4)
