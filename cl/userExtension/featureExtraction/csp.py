...
class CSP:
	...
	def make_filters(self, class_1, class_2, n__components = 8):
		if len(class_1) == len(class_2):
			print("Both dataframes are of the same length:", len(class_1))
		else:
			print("The dataframes have different lengths. Length of class_1:", len(class_1), "and length of class_2:", len(class_2))
