...
path = "experiment/H-PG5r9Y/kfolder" #where to save intermediate npy files
...
def fullKfold(subject):
    ...
    base_path = f"data/AqtdmmRR/train_set_homogenious_csp/filter_sub_{subject}_2_4"
    ...
    for x in range(0,nFold):
        ...
        subprocess.run(['python3', "-m", "experiment.H-PG5r9Y.runCrossValGroup", "-subject", str(subject), "-kfold", str(x)])
